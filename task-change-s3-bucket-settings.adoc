...
summary: 当您的 Amazon S3 系统在“系统”页面中可用时，您可以直接从NetApp Console更改某些存储桶属性。 
---
= 更改 S3 存储桶设置
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
当您的 Amazon S3 系统在“系统”页面中可用时，您可以直接从NetApp Console更改某些存储桶属性。
...
image:screenshot-edit-amazon-s3-bucket.png["该屏幕截图显示了如何选择“管理器详细信息”按钮来编辑存储桶属性。"]
...
默认情况下， NetApp Console创建的新存储桶中的标签是禁用的。 https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-tagging.html["从 Amazon S3 文档了解有关标记的更多信息"^] 。
...
默认情况下，使用NetApp Console创建的新存储桶中的“Amazon S3 托管密钥 (SSE-S3)”启用加密。 https://docs.aws.amazon.com/AmazonS3/latest/userguide/serv-side-encryption.html["从 Amazon S3 文档了解有关服务器端加密的更多信息"^] 。
